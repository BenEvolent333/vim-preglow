...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Statement", s:ember, "", "")
    call <SID>X("Conditional", s:ember, "", "")
    call <SID>X("Repeat", s:ember, "", "")
    call <SID>X("Structure", s:ember, "", "")
    ...
    call <SID>X("Define", s:ember, "", "")
    call <SID>X("Include", s:ember, "", "")
    ...
    " Vim Highlighting
    call <SID>X("vimCommand", s:ember, "", "NONE")

    " C Highlighting
    call <SID>X("cType", s:ember, "", "")
    call <SID>X("cStorageClass", s:orange, "", "")
    call <SID>X("cConditional", s:yellow, "", "")
    call <SID>X("cRepeat", s:ember, "", "")

    " PHP Highlighting
    call <SID>X("phpVarSelector", s:ember, "", "")
    call <SID>X("phpKeyword", s:ember, "", "")
    call <SID>X("phpRepeat", s:ember, "", "")
    1call <SID>X("phpConditional", s:yellow, "", "")
    call <SID>X("phpStatement", s:ember, "", "")
    ...
    call <SID>X("rubyConditional", s:ember, "", "")
    call <SID>X("rubyRepeat", s:ember, "", "")
    call <SID>X("rubyControl", s:ember, "", "")
    call <SID>X("rubyException", s:ember, "", "")
    ...
    call <SID>X("crystalConditional", s:ember, "", "")
    call <SID>X("crystalRepeat", s:ember, "", "")
    call <SID>X("crystalControl", s:ember, "", "")
    call <SID>X("crystalException", s:ember, "", "")

    " Python Highlighting
    call <SID>X("pythonInclude", s:green, "", "italic")
    call <SID>X("pythonStatement", s:blue, "", "")
    call <SID>X("pythonConditional", s:ember, "", "")
    call <SID>X("pythonRepeat", s:ember, "", "")
    call <SID>X("pythonException", s:orange, "", "")
    call <SID>X("pythonFunction", s:green, "", "italic")
    call <SID>X("pythonPreCondit", s:ember, "", "")
    call <SID>X("pythonExClass", s:orange, "", "")
    call <SID>X("pythonBuiltin", s:blue, "", "")
    call <SID>X("pythonOperator", s:ember, "", "")
    call <SID>X("pythonNumber", s:purple, "", "")
    call <SID>X("pythonString", s:yellow, "", "")
    call <SID>X("pythonRawString", s:yellow, "", "")
    call <SID>X("pythonDecorator", s:ember, "", "")
    ...
    call <SID>X("texMath", s:ember, "", "NONE")
    call <SID>X("texMathMacher", s:yellow, "", "NONE")
    call <SID>X("texRefLabel", s:ember, "", "NONE")
    ...
    call <SID>X("coffeeRepeat", s:ember, "", "")
    call <SID>X("coffeeConditional", s:ember, "", "")
    call <SID>X("coffeeKeyword", s:ember, "", "")
    call <SID>X("coffeeObject", s:yellow, "", "")

    " HTML Highlighting
    call <SID>X("htmlTag", s:blue, "", "")
    call <SID>X("htmlEndTag", s:blue, "", "")
    call <SID>X("htmlTagName", s:ember, "", "bold")
    call <SID>X("htmlArg", s:green, "", "italic")
    call <SID>X("htmlScriptTag", s:ember, "", "")
    ...
    call <SID>X("ShowMarksHLo", s:ember, s:background, "NONE")
    call <SID>X("ShowMarksHLu", s:yellow, s:background, "NONE")
    call <SID>X("ShowMarksHLm", s:ember, s:background, "NONE")

    " Lua Highlighting
    call <SID>X("luaStatement", s:ember, "", "")
    call <SID>X("luaRepeat", s:ember, "", "")
    call <SID>X("luaCondStart", s:ember, "", "")
    call <SID>X("luaCondElseif", s:ember, "", "")
    call <SID>X("luaCond", s:ember, "", "")
    call <SID>X("luaCondEnd", s:ember, "", "")
    ...
    " Go Highlighting
    call <SID>X("goDirective", s:ember, "", "")
    call <SID>X("goDeclaration", s:ember, "", "")
    call <SID>X("goStatement", s:ember, "", "")
    call <SID>X("goConditional", s:ember, "", "")
    call <SID>X("goConstants", s:orange, "", "")
    call <SID>X("goTodo", s:red, "", "")
    call <SID>X("goDeclType", s:blue, "", "")
    call <SID>X("goBuiltins", s:ember, "", "")
    call <SID>X("goRepeat", s:ember, "", "")
    call <SID>X("goLabel", s:ember, "", "")
    ...
    call <SID>X("clojureSpecial", s:ember, "", "")
    ...
    " Scala Highlighting
    call <SID>X("scalaKeyword", s:ember, "", "")
    call <SID>X("scalaKeywordModifier", s:ember, "", "")
    call <SID>X("scalaOperator", s:blue, "", "")
    call <SID>X("scalaPackage", s:ember, "", "")
    call <SID>X("scalaFqn", s:foreground, "", "")
    call <SID>X("scalaFqnSet", s:foreground, "", "")
    call <SID>X("scalaImport", s:ember, "", "")
    call <SID>X("scalaBoolean", s:orange, "", "")
    call <SID>X("scalaDef", s:ember, "", "")
    call <SID>X("scalaVal", s:ember, "", "")
    call <SID>X("scalaVar", s:ember, "", "")
    call <SID>X("scalaClass", s:ember, "", "")
    call <SID>X("scalaObject", s:ember, "", "")
    call <SID>X("scalaTrait", s:ember, "", "")
